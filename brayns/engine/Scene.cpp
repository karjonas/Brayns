...
void Scene::buildDefault()
{
    ...
    Vector3f p01{62.f, 88.f, 10.f};
    Vector3f p02{136.f, 48.f, 0.f};
    Vector3f p03{139.f, 69.f, 20.f};

    Vector3f p10{139.f, 69.f, 20.f}; // Spline 2
    Vector3f p11{171.f, 127.f, 0.f};
    Vector3f p12{276.f, 159.f, 40.f};
    Vector3f p13{195.f, 155.f, 0.f};

    Vector3f p20{195.f, 155.f, 0.f}; // Spline 3
    Vector3f p21{185.f, 155.f, 30.f};
    Vector3f p22{185.f, 205.f, 10.f};
    Vector3f p23{233.f, 205.f, 0.f};

    size_t materialId = 0;
    auto material = model->createMaterial(materialId, "spline");
